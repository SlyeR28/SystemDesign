...
public class NowOrder implements OrderFactory{
    @Override
    public Order createFactory(User user, Cart cart, Resturant resturant, List<Menu> menuList, PaymentStrategy paymentStrategy, double totalCost, String orderType) {
